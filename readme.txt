...
For updates/support please visit [full version](https://wpxtre.me/product/shortcodes-manager)

= Features =

* Write your shortcode with the shortcode editor
* Display all registered shortcodes
...
* [Full Version](https://wpxtre.me/product/shortcodes-manager)
...
1. Upload the entire content of plugin archive to your `/wp-content/plugins/` directory,
   so that everything will remain in a `/wp-content/plugins/wpx-shortcodes-manager-light/` folder
...
You can try the complete version on wpXtreme [Server](https://wpxtre.me/product/shortcodes-manager)
...
1. Shortcodes analysis Preferences
2. List of registered shortcodes
3. Help on line
4. Shortcodes analysis while edit
4. Shortcodes analysis Warning while edit

== Changelog ==

= 1.0.8 =
* First wordpress.org light version
